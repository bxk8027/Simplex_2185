...
class AppClass 
{
	...
	/*uniform float compVertex1 = glm::vec3(1.0f, 0.0f, 0.0f);
	glUniform1f compVertex1 = glm::vec3(1.0f, 0.0f, 0.0f);
	glUniform1f compVertex2 = glm::vec3(0.0f, 1.0f, 0.0f);
	glUniform1f compVertex3 = glm::vec3(0.0f, 0.0f, 1.0f);*/
